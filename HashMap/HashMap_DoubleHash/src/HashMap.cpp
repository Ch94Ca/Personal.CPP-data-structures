...
// função de dispersão com o método dupla dispersão
...
{   
    ...
    // primeira função de dispersão - método da divisão
    unsigned int hash_0 = key % size;

    // segunda função de dispersão
    unsigned int hash_1 = (size - 2) - key % (size - 2);

    // retorna o índice mapeado pela função
    // Quando o número de tentativas for 0, o 
